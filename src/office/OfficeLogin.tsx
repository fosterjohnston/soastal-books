    ...
    <div className="flex min-h-svh items-center justify-center bg-ink px-4">
      <form onSubmit={(e) => void onSubmit(e)} className="w-full max-w-md rounded-2xl bg-paper p-8 shadow-xl">
        ...
        <p className="mt-2 text-sm text-ink-2">
          Office accrual books. Foster and Keith sign in here — not Vercel, not OneDrive, not GitHub. This is not the
          field app. Keith&apos;s live spreadsheet is never written.
        </p>
        <div className="mt-6">
          <Field label="Office PIN">
            <Input
              type="password"
              inputMode="numeric"
